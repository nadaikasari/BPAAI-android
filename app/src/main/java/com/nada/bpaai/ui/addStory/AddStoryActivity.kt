package com.nada.bpaai.ui.addStory
...
import com.nada.bpaai.ui.rotateBitmap
import com.nada.bpaai.ui.uriToFile
...
class AddStoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.uploadButton.setOnClickListener {
            ...
            if(desc.isNotEmpty()) {
                ...
                showMessage(getString(R.string.description_empty))
            }
        }
    ...
    private fun uploadImage() {
        if (getFile != null) {
            ...
            viewModel.getResponse.observe(this@AddStoryActivity) {
                if (!it.error) {
